...
**Tech Stack:**
- **Backend:** Java 17, Spring Boot 3.x, PostgreSQL, Flyway migrations
- **Integration:** Telegram Bot API, National Bank of Kazakhstan API
- **Infrastructure:** Docker, Railway (CI/CD), automated deployments
- **Features:** Phone verification, smart request matching, rating system, deal history
...
✨ *Always learning. Always building. Always shipping to production.*  

---

### 💼 Open to Opportunities
Currently seeking **Junior Software Engineer** positions in backend development.  
Interested in: Microservices • Cloud Infrastructure • Scalable Systems • Fintech

**Location:** Poland 🇵🇱 | Open to EU remote opportunities
